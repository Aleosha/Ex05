...
namespace Ex2
{
    public class GameConsole
    {
        ...
        private const int k_DontPlayAgainCode = 2;
        private const int k_HumanPlayerCode = 1;
        private const int k_ComputerPlayerCode = 2;
        ...
        private void printGameEndingStatus()
        {
            ...
            {
                System.Console.WriteLine("The game is unfinished.");
            }
            else
            {
        ...
        private bool proposeNewGame()
        {
            ...
            do
            {
                System.Console.WriteLine("Enter {0} to continue or {1} to end:", k_PlayAgainCode, k_DontPlayAgainCode);
                string inputText = System.Console.ReadLine();
                numberIsInt = int.TryParse(inputText, out playAgain);
                if (!numberIsInt || (playAgain != k_PlayAgainCode && playAgain != k_DontPlayAgainCode))
                {
            ...
            return playAgain == k_PlayAgainCode ? true : false;
        }
        ...
        private ePlayerType getPlayerTypeFromUser()
        {
            ...
            do
            {
                System.Console.WriteLine("Please enter {0} for Human player or {1} for Computer:", k_HumanPlayerCode, k_ComputerPlayerCode);
                string inputText = System.Console.ReadLine();
                numberIsInt = int.TryParse(inputText, out numericPlayerType);
                if (!numberIsInt || (numericPlayerType != k_HumanPlayerCode && numericPlayerType != k_ComputerPlayerCode))
                {
                    System.Console.WriteLine("The input you entered is invalid.");
                }
                else
        ...
        private int getBoardSizeFromUser()
        {
            ...
            do
            {
                System.Console.WriteLine("Please enter desired board size ({0}-{1}):", k_MinBoardSize, k_MaxBoardSize);
                string inputText = System.Console.ReadLine();
